# ChatGPT Project Doc: Apollo 13 oxygen tank failure: source-bounded incident review
...
- Safe return alone does not prove the original system was acceptably safe (N3)
